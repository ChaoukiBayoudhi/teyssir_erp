...
- **Docs present:** `README.md`, `docs/INSTALL-WINDOWS.md`, `docs/ARCHITECTURE.md`, `docs/POSTGRESQL-SETUP.md`, `docs/INSTALLATION-QA.md` (plus sibling guides when those PRs are merged: LOCAL-AI, PDF-CONVERSION, BOOK-OCR).
